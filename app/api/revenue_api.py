...
# from app.services.analytics_service import generate_granular_graph

# router = APIRouter()

# @router.get("/get_revenue_graph", response_class=JSONResponse)
...
#         graph_data = generate_granular_graph(year, month, granularity)
#     else:
